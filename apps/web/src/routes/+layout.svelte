...
<Navbar>
	...
	<NavHamburger />
	<NavUl {activeUrl}>
		<NavLi href={localizeHref('/', { locale: currentLocale })}>{m.topBar_home()}</NavLi>
		<NavLi href={localizeHref('/device', { locale: currentLocale })}>{m.topBar_devices()}</NavLi>
		<NavLi href={localizeHref('/data', { locale: currentLocale })}>{m.topBar_data()}</NavLi>
	</NavUl>
